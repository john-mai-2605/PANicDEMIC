...
def run(num_samples = 30000, num_sentences = 10, verbose = False):
        ...
        for i in check_anger[:len(check_anger)//100]:
            print(i)
        ...
        for i in check_joy[:len(check_joy)//100]:
            print(i)
        ...
        for check in checks:
            ...
            fig = plt.figure()
            fig.suptitle(title[titlei],fontsize=20)
            titlei=titlei+1
